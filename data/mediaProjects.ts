...
export const MEDIA_PROJECTS: MediaProject[] = [
  {
    ...
    description:
      "Fri, 21 Nov 2025 - 12:00
Solar Installations Showcase
Located in Kala Khiel, this solar inverter installation project demonstrates our commitment to delivering efficient and reliable renewable energy solutions. 
  The system is designed to maximize energy output while ensuring long-term performance. Explore the images to see the installation process, system setup, and the final outcome of our work",
    images: [
